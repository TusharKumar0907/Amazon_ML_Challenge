...
if __name__ == "__main__":
    #Usage example: python sanity.py --test_filename test.csv --output_filename test_out.csv
...
sanity_check('test.csv','test_out.csv')
  
# sanity.py --test_filename test.csv --output_filename test_out.csv 